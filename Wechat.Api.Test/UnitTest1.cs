...
{
    public class AAMessageListenerConcurrently : MessageListenerConcurrently
    {
        ...
        public class UnitTest1
        {
            ...
            public void TestCache()
            {
                ...
                cache.HashSet(ConstCacheKey.GetWxIdKey(), "444", new CustomerInfoCache() { WxId = "aaaaaaaaaa" });
                cache.HashSet(ConstCacheKey.GetWxIdKey(), "555", new CustomerInfoCache() { WxId = "ccccccccccc" });
                cache.HashSet(ConstCacheKey.GetWxIdKey(), "6666", new CustomerInfoCache() { WxId = "bbbbbbbbbbbb" });
